export default async function handler(req, res) {
    ...
    // Added specific instruction for proper Table/Markdown formatting based on request
...
1. Dynamic Depth Scaling:
   ...
   - For complex, technical, creative, or multi-step queries: Provide comprehensive, well-structured answers using Markdown.
...
- When generating tables or comparisons, STRICTLY use standard Markdown table formats with clean alignments so it renders beautifully on the frontend.
`;
